...
<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;">
    ...
    <div id="windows1">
        <div id="loginbox" >
            <s:form action="User_login" method="post"  onsubmit=""  name="loginForm"  namespace="/" id="loginForm">
               <%--logo--%>
                        ...
                        <div>
                            ...
                            <%--<span class="pull-right"><a onclick="severCheck();" class="flip-link btn btn-info" id="to-recover">登录</a></span>--%>
                                <p id="colored-button" class="text-right">
                                    <a class="btn float-button-light waves-effect waves-button waves-float waves-light" id="DL"  onclick="">登 录</a>
    ...
    <div id="windows2" style="display: none;">
        <div id="loginbox">
            ...
            <div class="controls">
                <div class="main_input_box">
                    <font color="white"><span id="nameerr">Copyright © C-query企业查询 2100</span></font>
                </div>
            </div>
        </div>
    </div>
